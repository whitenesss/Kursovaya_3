...
def test_myabs():
    ...
    # assert print_display_to_user(5, 3) == "13.11.2019 Перевод со счета на счет", "Счет 38611 4**** ***** *9794 -> Счет **8125", "62814.53руб.", "None"
